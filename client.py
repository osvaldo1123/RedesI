...
try:
    while True:
        ...
        board_str = client_socket.recv(BUFFER_SIZE).decode('utf-8')
        ...
        while True:
            ...
            move = input("Insira a linha e a coluna (separadas por vírgula): ")
    ...
    final_board_str = client_socket.recv(BUFFER_SIZE).decode('utf-8')
    print(final_board_str)
    client_socket.close()
